## DexWM: World Models Can Leverage Human Videos for Dexterous Manipulation <br><sub>Official PyTorch Implementation</sub>

### [Paper](https://arxiv.org/pdf/2512.13644) | [Project Page](https://raktimgg.github.io/dexwm/) | [Models]()

This repo contains the official PyTorch implementation of DexWM: World Models Can Leverage Human Videos for Dexterous Manipulation.
...
- [x] Pre-Training Code
- [x] Fine-Tuning Code
- [x] Offline Evaluation on EgoDex
- [x] Robo Task Evaluation
- [x] Code Tested on DINOv2 backbone
- [x] RoboCasa Setup
- [ ] Testing Code on other backbones
- [ ] Add Meta Copyright/Licence information in every python file
- [ ] Dataset Upload/Download
- [ ] Model Checkpoints
- [ ] Simulation Data Generation (if we don't get approval for dataset release)

## Setup
Download the repo and set up the environment:
```
git clone ttps://github.com/facebookresearch/dexwm
...
Download the [EgoDex](https://github.com/apple/ml-egodex), [DROID]() (TODO: droid_100 and include .json file), [RoboCasa Random]() (TODO: Release this) datasets. See the end of this README for the expected directory structure inside each dataset folder.
...
2. Download the [Pick-and-Place]() dataset. It provides the visual goal images used for the manipulation tasks.
3. Run evaluation
   ```bash
